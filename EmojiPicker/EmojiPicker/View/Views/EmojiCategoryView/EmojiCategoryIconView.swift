...
extension EmojiCategoryIconView {
    ...
    private class CategoryIconsDrawKit: NSObject {
        ...
        public class func drawPeopleCategory(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 400, height: 400), resizing: ResizingBehavior = .aspectFit, tintColor: UIColor) {
            ...
            clipPath.move(to: CGPoint(x: 65, y: 235.47))
            clipPath.addCurve(to: CGPoint(x: 199.5, y: 349), controlPoint1: CGPoint(x: 65, y: 272.52), controlPoint2: CGPoint(x: 116.41, y: 349))
            clipPath.addCurve(to: CGPoint(x: 334, y: 235.47), controlPoint1: CGPoint(x: 282.27, y: 349), controlPoint2: CGPoint(x: 334, y: 272.52))
            clipPath.addCurve(to: CGPoint(x: 199.5, y: 235.47), controlPoint1: CGPoint(x: 334, y: 198.42), controlPoint2: CGPoint(x: 273.79, y: 235.47))
            clipPath.addCurve(to: CGPoint(x: 65, y: 235.47), controlPoint1: CGPoint(x: 125.21, y: 235.47), controlPoint2: CGPoint(x: 65, y: 198.42))
            clipPath.close()
            clipPath.usesEvenOddFillRule = true
            clipPath.addClip()
            
            let bezier3Path = UIBezierPath()
            bezier3Path.move(to: CGPoint(x: 65, y: 235.47))
            bezier3Path.addCurve(to: CGPoint(x: 199.5, y: 349), controlPoint1: CGPoint(x: 65, y: 272.52), controlPoint2: CGPoint(x: 116.41, y: 349))
            bezier3Path.addCurve(to: CGPoint(x: 334, y: 235.47), controlPoint1: CGPoint(x: 282.27, y: 349), controlPoint2: CGPoint(x: 334, y: 272.52))
            bezier3Path.addCurve(to: CGPoint(x: 199.5, y: 235.47), controlPoint1: CGPoint(x: 334, y: 198.42), controlPoint2: CGPoint(x: 273.79, y: 235.47))
            bezier3Path.addCurve(to: CGPoint(x: 65, y: 235.47), controlPoint1: CGPoint(x: 125.21, y: 235.47), controlPoint2: CGPoint(x: 65, y: 198.42))
            bezier3Path.close()
            tintColor.setStroke()
            bezier3Path.lineWidth = 32
            bezier3Path.miterLimit = 32
            bezier3Path.stroke()
            ...
            clip2Path.move(to: CGPoint(x: 96.82, y: 258))
            clip2Path.addCurve(to: CGPoint(x: 199, y: 288), controlPoint1: CGPoint(x: 124.15, y: 278), controlPoint2: CGPoint(x: 158.21, y: 288))
            clip2Path.addCurve(to: CGPoint(x: 301.18, y: 258), controlPoint1: CGPoint(x: 239.79, y: 288), controlPoint2: CGPoint(x: 273.85, y: 278))
            clip2Path.addCurve(to: CGPoint(x: 302, y: 256.39), controlPoint1: CGPoint(x: 301.7, y: 257.63), controlPoint2: CGPoint(x: 302, y: 257.03))
            clip2Path.addLine(to: CGPoint(x: 302, y: 239.93))
            clip2Path.addCurve(to: CGPoint(x: 300, y: 237.93), controlPoint1: CGPoint(x: 302, y: 238.82), controlPoint2: CGPoint(x: 301.1, y: 237.93))
            clip2Path.addCurve(to: CGPoint(x: 299.28, y: 238.06), controlPoint1: CGPoint(x: 299.75, y: 237.93), controlPoint2: CGPoint(x: 299.51, y: 237.97))
            clip2Path.addCurve(to: CGPoint(x: 199, y: 257.4), controlPoint1: CGPoint(x: 265.85, y: 250.95), controlPoint2: CGPoint(x: 232.43, y: 257.4))
            clip2Path.addCurve(to: CGPoint(x: 98.72, y: 238.06), controlPoint1: CGPoint(x: 165.57, y: 257.4), controlPoint2: CGPoint(x: 132.15, y: 250.95))
            clip2Path.addCurve(to: CGPoint(x: 96.13, y: 239.21), controlPoint1: CGPoint(x: 97.69, y: 237.67), controlPoint2: CGPoint(x: 96.53, y: 238.18))
            clip2Path.addCurve(to: CGPoint(x: 96, y: 239.93), controlPoint1: CGPoint(x: 96.05, y: 239.44), controlPoint2: CGPoint(x: 96, y: 239.68))
            clip2Path.addLine(to: CGPoint(x: 96, y: 256.39))
            clip2Path.addCurve(to: CGPoint(x: 96.82, y: 258), controlPoint1: CGPoint(x: 96, y: 257.03), controlPoint2: CGPoint(x: 96.3, y: 257.63))
            clip2Path.close()
            clip2Path.move(to: CGPoint(x: 78, y: 219.92))
            clip2Path.addLine(to: CGPoint(x: 320, y: 219.92))
            clip2Path.addLine(to: CGPoint(x: 320, y: 306))
            clip2Path.addLine(to: CGPoint(x: 78, y: 306))
            clip2Path.addLine(to: CGPoint(x: 78, y: 219.92))
            clip2Path.close()
            clip2Path.usesEvenOddFillRule = true
            clip2Path.addClip()
            
            let bezier5Path = UIBezierPath()
            bezier5Path.move(to: CGPoint(x: 96.82, y: 258))
            bezier5Path.addCurve(to: CGPoint(x: 199, y: 288), controlPoint1: CGPoint(x: 124.15, y: 278), controlPoint2: CGPoint(x: 158.21, y: 288))
            bezier5Path.addCurve(to: CGPoint(x: 301.18, y: 258), controlPoint1: CGPoint(x: 239.79, y: 288), controlPoint2: CGPoint(x: 273.85, y: 278))
            bezier5Path.addCurve(to: CGPoint(x: 302, y: 256.39), controlPoint1: CGPoint(x: 301.7, y: 257.63), controlPoint2: CGPoint(x: 302, y: 257.03))
            bezier5Path.addLine(to: CGPoint(x: 302, y: 239.93))
            bezier5Path.addCurve(to: CGPoint(x: 300, y: 237.93), controlPoint1: CGPoint(x: 302, y: 238.82), controlPoint2: CGPoint(x: 301.1, y: 237.93))
            bezier5Path.addCurve(to: CGPoint(x: 299.28, y: 238.06), controlPoint1: CGPoint(x: 299.75, y: 237.93), controlPoint2: CGPoint(x: 299.51, y: 237.97))
            bezier5Path.addCurve(to: CGPoint(x: 199, y: 257.4), controlPoint1: CGPoint(x: 265.85, y: 250.95), controlPoint2: CGPoint(x: 232.43, y: 257.4))
            bezier5Path.addCurve(to: CGPoint(x: 98.72, y: 238.06), controlPoint1: CGPoint(x: 165.57, y: 257.4), controlPoint2: CGPoint(x: 132.15, y: 250.95))
            bezier5Path.addCurve(to: CGPoint(x: 96.13, y: 239.21), controlPoint1: CGPoint(x: 97.69, y: 237.67), controlPoint2: CGPoint(x: 96.53, y: 238.18))
            bezier5Path.addCurve(to: CGPoint(x: 96, y: 239.93), controlPoint1: CGPoint(x: 96.05, y: 239.44), controlPoint2: CGPoint(x: 96, y: 239.68))
            bezier5Path.addLine(to: CGPoint(x: 96, y: 256.39))
            bezier5Path.addCurve(to: CGPoint(x: 96.82, y: 258), controlPoint1: CGPoint(x: 96, y: 257.03), controlPoint2: CGPoint(x: 96.3, y: 257.63))
            bezier5Path.close()
            tintColor.setStroke()
            bezier5Path.lineWidth = 34
            bezier5Path.miterLimit = 34
            bezier5Path.stroke()
            ...
            bezier7Path.move(to: CGPoint(x: 200, y: 339))
            bezier7Path.addCurve(to: CGPoint(x: 265.82, y: 322.57), controlPoint1: CGPoint(x: 231.63, y: 335.69), controlPoint2: CGPoint(x: 253.57, y: 330.21))
            bezier7Path.addCurve(to: CGPoint(x: 302, y: 275.35), controlPoint1: CGPoint(x: 278.07, y: 314.92), controlPoint2: CGPoint(x: 290.13, y: 299.18))
            bezier7Path.addCurve(to: CGPoint(x: 199, y: 293.82), controlPoint1: CGPoint(x: 256.38, y: 287.45), controlPoint2: CGPoint(x: 222.05, y: 293.61))
            bezier7Path.addCurve(to: CGPoint(x: 96, y: 277.27), controlPoint1: CGPoint(x: 175.95, y: 294.04), controlPoint2: CGPoint(x: 141.62, y: 288.52))
            bezier7Path.addCurve(to: CGPoint(x: 137.22, y: 322.57), controlPoint1: CGPoint(x: 111.23, y: 300.2), controlPoint2: CGPoint(x: 124.97, y: 315.3))
            bezier7Path.addCurve(to: CGPoint(x: 200, y: 339), controlPoint1: CGPoint(x: 149.47, y: 329.84), controlPoint2: CGPoint(x: 170.4, y: 335.32))
            bezier7Path.close()
            bezier7Path.usesEvenOddFillRule = true
            tintColor.setFill()
            bezier7Path.fill()

            let oval5Path = UIBezierPath(ovalIn: CGRect(x: 234, y: 126, width: 42, height: 57))
            tintColor.setFill()
            oval5Path.fill()
            
            let oval3Path = UIBezierPath(ovalIn: CGRect(x: 124, y: 126, width: 42, height: 57))
            tintColor.setFill()
            oval3Path.fill()
        ...
        // MARK: - Activity Category
         ...
         public class func drawActivityCategory(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 400, height: 400), resizing: ResizingBehavior = .aspectFit, tintColor: UIColor) {
            ...
            let bezier3Path = UIBezierPath()
            bezier3Path.move(to: CGPoint(x: 219.36, y: 51.18))
            bezier3Path.addLine(to: CGPoint(x: 219.36, y: 22.29))
            bezier3Path.addLine(to: CGPoint(x: 222.2, y: 22.68))
            bezier3Path.addCurve(to: CGPoint(x: 331.23, y: 78.5), controlPoint1: CGPoint(x: 264.43, y: 28.47), controlPoint2: CGPoint(x: 304.27, y: 50.05))
            bezier3Path.addLine(to: CGPoint(x: 334.14, y: 83.09))
            bezier3Path.addLine(to: CGPoint(x: 290.26, y: 103.94))
            bezier3Path.addLine(to: CGPoint(x: 271.36, y: 96.97))
            bezier3Path.addLine(to: CGPoint(x: 221.76, y: 65.9))
            bezier3Path.addLine(to: CGPoint(x: 219.36, y: 51.18))
            bezier3Path.close()
            bezier3Path.usesEvenOddFillRule = true
            tintColor.setFill()
            bezier3Path.fill()
        ...
        // MARK: - Objects Category
         ...
         public class func drawObjectsCategory(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 400, height: 400), resizing: ResizingBehavior = .aspectFit, tintColor: UIColor) {
            ...
            let rectangle2Path = UIBezierPath(rect: CGRect(x: 158.1, y: 335.47, width: 52.9, height: 20.55))
            tintColor.setFill()
            rectangle2Path.fill()
            ...
            let bezier2Path = UIBezierPath()
            bezier2Path.move(to: CGPoint(x: 199.07, y: 7))
            bezier2Path.addCurve(to: CGPoint(x: 67, y: 135.67), controlPoint1: CGPoint(x: 123.58, y: 7), controlPoint2: CGPoint(x: 67, y: 64.73))
            bezier2Path.addCurve(to: CGPoint(x: 98.16, y: 229.46), controlPoint1: CGPoint(x: 67, y: 171.81), controlPoint2: CGPoint(x: 76.75, y: 210.58))
            bezier2Path.addCurve(to: CGPoint(x: 136.21, y: 300.54), controlPoint1: CGPoint(x: 118.3, y: 250.79), controlPoint2: CGPoint(x: 132.99, y: 273.33))
            bezier2Path.addLine(to: CGPoint(x: 138.69, y: 321.52))
            bezier2Path.addLine(to: CGPoint(x: 138.69, y: 368.62))
            bezier2Path.addCurve(to: CGPoint(x: 157.44, y: 389.73), controlPoint1: CGPoint(x: 138.69, y: 379), controlPoint2: CGPoint(x: 146.57, y: 387.88))
            bezier2Path.addCurve(to: CGPoint(x: 199.07, y: 393), controlPoint1: CGPoint(x: 167.3, y: 391.42), controlPoint2: CGPoint(x: 186.97, y: 393))
            bezier2Path.addCurve(to: CGPoint(x: 240.7, y: 389.73), controlPoint1: CGPoint(x: 211.17, y: 393), controlPoint2: CGPoint(x: 230.84, y: 391.42))
            bezier2Path.addCurve(to: CGPoint(x: 259.45, y: 368.62), controlPoint1: CGPoint(x: 251.57, y: 387.88), controlPoint2: CGPoint(x: 259.45, y: 379))
            bezier2Path.addLine(to: CGPoint(x: 259.45, y: 321.52))
            bezier2Path.addLine(to: CGPoint(x: 261.93, y: 300.54))
            bezier2Path.addCurve(to: CGPoint(x: 299.98, y: 229.46), controlPoint1: CGPoint(x: 265.15, y: 273.33), controlPoint2: CGPoint(x: 280.22, y: 249.95))
            bezier2Path.addCurve(to: CGPoint(x: 331.52, y: 135.67), controlPoint1: CGPoint(x: 321.34, y: 210.16), controlPoint2: CGPoint(x: 331.52, y: 171.81))
            bezier2Path.addCurve(to: CGPoint(x: 199.07, y: 7), controlPoint1: CGPoint(x: 331.52, y: 64.73), controlPoint2: CGPoint(x: 274.57, y: 7))
            bezier2Path.addLine(to: CGPoint(x: 199.07, y: 7))
            bezier2Path.close()
            tintColor.setStroke()
        ...
        // MARK: - Flags Category
         ...
         public class func drawFlagsCategory(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 400, height: 400), resizing: ResizingBehavior = .aspectFit, tintColor: UIColor) {
            ...
            bezierPath.addLine(to: CGPoint(x: 46, y: 394))
            bezierPath.addLine(to: CGPoint(x: 67.99, y: 394))
            bezierPath.addLine(to: CGPoint(x: 67.99, y: 241.08))
            bezierPath.addCurve(to: CGPoint(x: 46, y: 20.09), controlPoint1: CGPoint(x: 67.99, y: 169.52), controlPoint2: CGPoint(x: 60.66, y: 95.85))
            bezierPath.close()
            bezierPath.usesEvenOddFillRule = true
            tintColor.setFill()
            bezierPath.fill()
            ...
            clipPath.addCurve(to: CGPoint(x: 45.99, y: 241.4), controlPoint1: CGPoint(x: 230.81, y: 164.37), controlPoint2: CGPoint(x: 169.21, y: 307.93))
            ...
            let bezier2Path = UIBezierPath()
            bezier2Path.move(to: CGPoint(x: 45.99, y: 241.38))
            bezier2Path.addLine(to: CGPoint(x: 45.99, y: 20.39))
            bezier2Path.addCurve(to: CGPoint(x: 353.99, y: 30.91), controlPoint1: CGPoint(x: 169.21, y: 95.34), controlPoint2: CGPoint(x: 230.81, y: -44.01))
            bezier2Path.addLine(to: CGPoint(x: 353.99, y: 230.88))
            bezier2Path.addCurve(to: CGPoint(x: 45.99, y: 241.4), controlPoint1: CGPoint(x: 230.81, y: 164.37), controlPoint2: CGPoint(x: 169.21, y: 307.93))
            bezier2Path.addLine(to: CGPoint(x: 45.99, y: 241.38))
            bezier2Path.close()
            tintColor.setStroke()
            bezier2Path.lineWidth = 44
            bezier2Path.miterLimit = 44
            bezier2Path.stroke()
